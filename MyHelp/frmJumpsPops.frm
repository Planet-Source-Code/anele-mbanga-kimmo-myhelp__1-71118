...
Private Sub cmdCancel_Click()
    ...
    Err.Clear
End Sub
Public Sub LoadJumpsPops(jCollection As Collection, pCollection As Collection)
    On Error Resume Next
    Dim nTot As Long
    Dim nCnt As Long
    Dim nStr As String
...
Private Sub lstTopics_ColumnClick(ByVal ColumnHeader As MSComctlLib.ColumnHeader)
    On Error Resume Next
    LstViewSwapSort lstTopics, ColumnHeader
    Err.Clear
End Sub
