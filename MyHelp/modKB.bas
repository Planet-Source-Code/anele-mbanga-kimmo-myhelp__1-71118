...
Public Function NextNewFile(ByVal StrFilePath As String, Optional IsCopy As Boolean = False) As String
    ...
    Err.Clear
End Function
Public Function FindWindowLike(TheWindows As clsWindows, hWndArray() As Long, ByVal hWndStart As Long, ByVal WindowText As String, Optional ByVal Classname As String = "ThunderRT6FormDC") As Integer
    On Error Resume Next
    Dim hwnd As Long
...
Public Function BrowseForFolder(hWndOwner As Long, sPrompt As String) As String
    ...
    Err.Clear
End Function
Public Function lngStartDoc(ByVal Docname As String, Optional ByVal Operation As String = "Open", Optional ByVal WindowState As Long = 1) As Long
    On Error Resume Next
    Dim Scr_hDC As Long
    Dim sDir As String
...
Public Function AlphaNumericOnly(ByVal strValue As String) As String
    ...
    Err.Clear
End Function
Public Function Alpha(ByVal strValue As String) As String
    On Error Resume Next
    Dim rsCnt As Long
    Dim rsTot As Long
    Dim rsStr As String
    ...
    For rsCnt = 1 To rsTot
        rsCur = Mid$(strValue, rsCnt, 1)
        If InStr(1, "ABCDEFGHIJKLMNOPQRSTUVWXYZ ", UCase$(rsCur)) > 0 Then
            rsStr = rsStr & rsCur
        Else
            rsStr = rsStr & "_"
        End If
...
Public Sub TreeView_DeleteNode(TV As TreeView, ByVal NodeText As String)
    ...
    Err.Clear
End Sub
Public Function RichToHTML(rtbRichTextBox As RichTextLib.RichTextBox, Optional lngStartPosition As Long = 0, Optional lngEndPosition As Long = 0) As String
    On Error Resume Next
    '**********************************************************
    ...
    Err.Clear
End Function
Public Function RGBtoHEX(lngColor As Long) As String
    On Error Resume Next
    Dim strHex As String
...
Public Sub Compile_Hpj(MeForm As Form, progBar As ProgressBar)
    ...
    tb.Index = "FullPath"
    Set tbProject = db.OpenRecordset("select * from [" & StringIconv(sProject) & "] order by sequence;")
    tbProject.MoveLast
    ...
    ' individual rtf files will be added to the project
    ...
    For nCnt = 1 To nTot
        ...
        Case False
            tContext = Trim$(StringRemNull(tb!Context))
            If Len(tContext) > 0 Then CompiledHPJ = CompiledHPJ & tContext & ".rtf" & vbCrLf
        End Select
        tbProject.MoveNext
        DoEvents
        Err.Clear
...
Public Function Compile_Baggage(MeForm As Form, progBar As ProgressBar) As String
    ...
    Err.Clear
End Function
Public Sub Compile_Rtf1(MeForm As Form, progBar As ProgressBar)
    On Error Resume Next
    Dim db As DAO.Database
    Dim tb As DAO.Recordset
    Dim tbProject As DAO.Recordset
    ...
    For nCnt = 1 To nTot
        ...
        pKeyWords = Keywords_Validate(pKeyWords)
...
Public Sub Compile_Rtf(MeForm As Form, progBar As ProgressBar)
    ...
    For nCnt = 1 To nTot
        ...
        pKeyWords = Replace$(pKeyWords, FM, ";")
        pFootNotes = Replace$(pFootNotes, FM, ";")
        rtfFile = File_Token(sProjDb, "p", "\") & "\" & pContext & ".rtf"
        If Len(pFootNotes) > 0 Then
            CompiledRTF = CompiledRTF & "A{\footnote " & MvRemoveDuplicates(pTitle & ";" & pFootNotes, ";") & "}"
        End If
        If Len(pMacros) > 0 Then
...
NextTopic:
        ...
        'rtfFile
        CompiledRTF = CompiledRTF & "}"
        FileUpdate rtfFile, CompiledRTF, "w"
...
Public Function DelimCount(ByVal StringMv As String, Optional ByVal Delim As String = "") As Long
    ...
    Err.Clear
End Function
Public Sub Compile_Project(Location As String)
    On Error Resume Next
    ...
    'hcw /c /m /n /a new
    ReturnValue = Shell(CompilerLocation & " /c /a /e /r " & Location)
    Err.Clear
End Sub
...
ErrHandler:
    ...
    Err.Clear
End Sub
Public Sub Word97Do(strMode As WordOperation, docWord As RichTextBox, Optional ByVal TopicContext As String = "")
    On Error Resume Next
...
Public Sub KillFolderTree(ByVal sFolder As String)
    ...
    Err.Clear
End Sub
Public Sub TreeViewSaveToTable(MeForm As Form, progBar As ProgressBar, ByVal Dbase As String, ByVal TbName As String, TreeV As TreeView)
    On Error Resume Next
...
Public Function RecycleFile(OwnerForm As Form, fromPaths As String, Optional toPaths As String = "", Optional intPerform As FileOps = foCopy) As Boolean
    ...
    Err.Clear
End Function
Public Sub RecurseFolderToComboBox(ByVal StartDirectory As String, cboBox As ComboBox, Optional FilesOnly As Boolean = True, Optional NamesOnly As Boolean = False)
    On Error Resume Next
    ...
    Err.Clear
End Sub
Public Sub ReloadMenu(MenuControl As Variant, LstFrom As ComboBox, Optional ByVal StrOwn As String = "", Optional ByVal StrBlank As String = "", Optional ByVal Ascending As Boolean = True, Optional ByVal NumberOfItemsToLoad As Long = -1, Optional ProperCase As Boolean = False)
    On Error Resume Next
    Dim menuTot As Long
    Dim menuCnt As Long
    Dim menuItm As Long
...
NextSection1:
    ...
    Err.Clear
End Sub
Public Sub TreeViewLoadFromTable(MeForm As Form, progBar As ProgressBar, ByVal Dbase As String, TreeFor As TreeView, ByVal TbName As String, Optional ByVal TreeClear As String = "y")
    On Error Resume Next
...
Public Sub Dao_ViewSQLNew(MeForm As Form, progBar As ProgressBar, ByVal DataSource As String, ByVal RecordSource As String, lstView As ListView, Optional ByVal Headings As String = "", Optional ByVal lstClear As String = "", Optional ByVal strImage As String = "", Optional ByVal strSelImage As String = "", Optional varCorrelate As Variant, Optional ByVal UpperCase As Boolean = False, Optional ByVal TagFldName As String = "", Optional ByVal ShowDay As String = "", Optional ByVal AmountFlds As String = "")
    ...
    Err.Clear
End Sub
Public Function TreeViewRemoveChecked(MeForm As Form, progBar As ProgressBar, treeDms As TreeView, Optional ByVal NodeChecked As Boolean = False) As String
    On Error Resume Next
    Dim treeTot As Long
    Dim treeCnt As Long
...
Public Function StringProperCase(ByVal StrString As String, Optional Delim As String = "\") As String
    ...
    Err.Clear
End Function
Public Function TreeViewAddPath(TreeV As TreeView, ByVal sPath As String, Optional ByVal Image As String = "", Optional ByVal SelectedImage As String = "", Optional ByVal Tag As String = "", Optional Delim As String = "\") As Long
    On Error Resume Next
    Dim prevP As String
    Dim currP As String
    Dim lngC As Long
...
Public Function StringRemoveDelim(ByVal strData As String, Optional ByVal Delim As String = "") As String
    ...
    Err.Clear
End Function
Public Function RemDelim(ByVal strData As String, Optional ByVal Delim As String = "") As String
    On Error Resume Next
    Dim intDataSize As Long
    Dim intDelimSize As Long
    Dim strLast As String
    ...
    Select Case LCase$(strLast)
    Case LCase$(Delim)
        RemDelim = Left$(strData, (intDataSize - intDelimSize))
    Case Else
        RemDelim = strData
    End Select
    Err.Clear
...
Public Sub CreateNestedDirectory(ByVal StrCompletePath As String)
    On Error Resume Next
    ...
    Err.Clear
End Sub
Public Function MyPrompt(ByVal StrMsg As String, Optional ByVal strButton As String = "o", Optional ByVal StrIcon As String = "e", Optional ByVal StrHeading As String = "") As Long
    On Error Resume Next
    ...
    Err.Clear
End Function
Private Sub TreeViewWriteToTable(MeForm As Form, progBar As ProgressBar, ByRef mRs As DAO.Recordset, TreeV As TreeView, Optional ByVal TbType As String = "n")
    On Error Resume Next
    ...
    cntNodes = 1
    mRs.Index = "Key"
    mRs.Seek "=", TreeV.Nodes(iIndex).Index
    ...
    Do While iIndex <> TreeV.Nodes(iTmp).LastSibling.Index
        ...
        mRs.Index = "Key"
        mRs.Seek "=", TreeV.Nodes(iIndex).Next.Index
        If mRs.EOF = True Then
            mRs.AddNew
        Else
            mRs.Edit
...
Public Function StringIconv(ByVal sValue As String, Optional ByVal sFormat As String = "") As String
    ...
    Err.Clear
End Function
Public Function MvRemoveBlanks(ByVal strValue As String, Optional ByVal Delim As String = "") As String
    On Error Resume Next
    Dim xData() As String
    Dim xTot As Long
    Dim xCnt As Long
...
Public Function TbFldNames(ByVal dbRs As DAO.Recordset, Optional ByVal Delim As String = ",") As String
    ...
    Err.Clear
End Function
Public Function NoCommas(ByVal strValue As String) As String
    On Error Resume Next
    NoCommas = Replace$(strValue, ",", "")
    Err.Clear
End Function
Public Function ProperAmount(ByVal strValue As String) As String
    On Error Resume Next
...
Public Function StringsConcat(ParamArray Items()) As String
    ...
    Err.Clear
End Function
Public Function StringPriority(ByVal valCur As Integer) As String
    On Error Resume Next
    Select Case valCur
    ...
    Err.Clear
End Function
Public Function StringSensitivity(ByVal valCur As Integer) As String
    On Error Resume Next
    Select Case valCur
    ...
    Err.Clear
End Function
Public Function StringStatus(ByVal valCur As Integer) As String
    On Error Resume Next
    Select Case valCur
    ...
    Err.Clear
End Function
Public Function StringFlag(ByVal intValue As Integer) As String
    On Error Resume Next
...
Public Function BranchString(strValue As String) As String
    ...
    Err.Clear
End Function
Public Function CallTypeString(optCallType As Integer) As String
    On Error Resume Next
    ...
    Err.Clear
End Function
Public Function ActionName(ByVal intValue As Integer) As String
    On Error Resume Next
    ...
    Err.Clear
End Function
Public Function RuleFieldName(ByVal intValue As Integer) As String
    On Error Resume Next
    Select Case intValue
...
Public Function MvFromCollection(objCollection As Collection, Optional ByVal Delim As String = "") As String
    ...
    Err.Clear
End Function
Private Sub TreeViewWriteChild(MeForm As Form, progBar As ProgressBar, ByVal iNodeIndex As Long, ByRef mRs As DAO.Recordset, TreeV As TreeView, Optional ByVal TbType As String = "n")
    On Error Resume Next
    ...
    For i = 1 To iTempChild
        ...
        Call UpdateProgress(MeForm, cntNodes, progBar, "Saving tree view to table...")
        mRs.Index = "Key"
        mRs.Seek "=", TreeV.Nodes(iTempIndex).Index
        If mRs.EOF = True Then
            mRs.AddNew
        Else
            mRs.Edit
...
Public Sub LstViewResizeMax(lstView As ListView)
    ...
    Err.Clear
End Sub
Public Sub TreeViewRefreshKeys(MeForm As Form, progBar As ProgressBar, TreeV As TreeView, Optional ByVal RenumberKeys As Boolean = True)
    On Error Resume Next
    Dim treeT As Long
    Dim treeC As Long
...
Private Sub IniHeadings()
    ...
    Err.Clear
End Sub
Public Sub AddStatusBar(Sobject As StatusBar, progBar As ProgressBar)
    On Error Resume Next
    Dim pnlA As Panel
    ...
    Err.Clear
End Sub
Public Sub ResizeStatusBar(objForm As Form, objStatusBar As StatusBar, progBar As ProgressBar)
    On Error Resume Next
    Dim lngSum As Long
...
Public Sub ProgBarClose(MeForm As Form, progBar As ProgressBar)
    ...
    Err.Clear
End Sub
Public Sub UpdateProgress(objForm As Form, ByVal minValue As Long, progBar As ProgressBar, Optional ByVal Note As String = "")
    On Error Resume Next
...
Public Sub RemoveUselessTopics(MeForm As Form, progBar As ProgressBar)
    ...
    Set tbT = db.OpenRecordset(StringIconv(sProject))
    ...
    For rsCnt = rsTot To 1 Step -1
        ...
        UpdateProgress MeForm, rsCnt, progBar, "Checking topic validity: " & sFullPath
        tbT.Seek "=", sFullPath
...
Public Function Jump_UpperCase(ByVal strValue As String) As String
    ...
    Err.Clear
End Function
Public Function StringNextFile(ByVal OriginalFile As String, Optional ByVal NewPath As String = "", Optional ByVal IncludeCopy As Boolean = True) As String
    On Error Resume Next
    Dim fCount As Long
...
Public Function ZipFile(MyZipLight As ZIPLight, ByVal ZipFileName As String, CompressionLevel As Integer, ParamArray FilesToAdd()) As String
    On Error Resume Next
...
Public Function MvRemoveItems(ByVal MvString As String, ByVal Delim As String, ParamArray Items()) As String
    ...
    spItemTot = StrParse(spItems, MvString, Delim)
    For Each Item In Items
    ...
    strNew = vbNullString
    For spItemCnt = 1 To spItemTot
        If spItems(spItemCnt) <> "" Then strNew = strNew & spItems(spItemCnt) & Delim
        Err.Clear
    Next
    MvRemoveItems = RemDelim(strNew, Delim)
    Err.Clear
End Function

Public Sub LstViewSwapSort(lstView As MSComctlLib.ListView, lstHeader As ColumnHeader)
    On Error Resume Next
